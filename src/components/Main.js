        ...
        <div id="main" className="flex flex-col sm:min-h-0 min-h-[calc(100vh-6.4rem)] pl-[3rem] lg:mt-2 lg:m-16 lg:pt-0 pr-[1rem] py-[0rem] md:mt-0 md:pt-0 tm:flex-col sm:flex-row sm:px-[1.5rem] sm:mt-0">
            <div className="flex flex-col sm:flex-row sm:items-center pt-0 justify-center w-full min-h-[58vh] tm:min-h-min tm:w-full sm:min-h-min sm:w-full sm:pt-0 tm:pt-0">
                <div className="flex flex-col justify-center sm:w-[70%] w-full sm:mr-5">
                    ...
                    <blockquote className="font-[800] text-[2rem] text-[#800080;] mt-[-10px] lg:text-[2.4rem] md:text-[2rem] tm:text-[2.5rem] sm:text-[1rem]">
                        I'm
                        <span className="before:block mx-4 mb-6 mt-4 before:absolute before:-inset-2 before:-skew-y-[3deg] before:bg-[#800080;] relative inline-block">
                            <span className="relative text-[#fffffff0] dark:text-[#800080]">Anita</span>
                        </span>
                    </blockquote>
                    ...
                    <div className="box" >
                        <div className="h-full justify-end flex items-center sm:justify-center">
                            <img
                                src={Profile}
                                alt="main"
                                className="h-[50%] min-h-[10px] min-w-[100px] tm:h-[36px] tm:mt-[200px] sm:min-h-[10px] sm:min-w-[100px] sm:ml-[30px]"
                            />
                        </div>
